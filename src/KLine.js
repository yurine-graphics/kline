...
class KLine {
  ...
  renderX(context, xAxis, x1, x2, y0, y1, y2, xNum, fontSize, lineHeight, max, min, minVolume, stepVol) {
    var w = x2 - x1;
  ...
  renderItem(context, i, xAxis, per, split, x1, y1, y2, min, step, minVolume, stepVol) {
