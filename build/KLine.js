var util=function(){var _0=require('./util');return _0.hasOwnProperty("default")?_0["default"]:_0}();
  ...
  KLine.prototype.renderX = function(context, x1, x2, y0, y1, y2, fontSize, max, min) {
    //去除时分秒，最小单位天数
  ...
  KLine.prototype.renderDay = function(context, x1, x2, y0, y1, y2, stepX, stepV, xNum, start, fontSize, max, min) {
  ...
  KLine.prototype.renderItem = function(context, i, per, split, x1, y0, y1, y2, fontSize, min, step) {
